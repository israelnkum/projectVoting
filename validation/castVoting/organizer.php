                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                    if (isset($_POST['btn_Scretary_skiped'])){

                                    $value = $_POST['btn_Scretary_skiped'];
                                    ...
                                    <div class='container'>
                                        <?php
                                        if ($row["postion"] == "Organizer" AND $row["votingName"] == $value){
                            ...
                            <div class="text-right">
                                ...
                                <?php
                                echo '<form method="post" action="asst_organizer.php">
                                    <button type="submit" name="btn_Organizer_skiped" class="btn btn-danger" value="'.$value.'">Skip <i class="fa fa-angle-double-right"></i></button>
                                </form>';
                                ?>
                            </div>
                        </div>
