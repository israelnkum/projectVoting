            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12 offset-md-0 text-center card-title">
                        <h1 class="display-4">Vice President</h1>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                    if (isset($_POST['btn_President_skiped'])){

                                    $value = $_POST['btn_President_skiped'];
                                    ...
                                    <div class='container'>
                                        <?php
                                        if ($row["postion"] == "Vice President" AND $row["votingName"] == $value){
                            ...
                            <div class="text-right">
                                ...
                                <?php
                                echo '<form method="post" action="secretaries.php">
                                    <button type="submit" name="btn_vicePresident_skiped" class="btn btn-danger" value="'.$value.'">Skip <i class="fa fa-angle-double-right"></i></button>
                                </form>';
                                ?>
                            </div>
                        </div>
