                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                    if (isset($_POST['btn_asstOrganizer_skiped'])){

                                    $value = $_POST['btn_asstOrganizer_skiped'];
                            ...
                            <div class="text-right">
                                ...
                                <?php
                                echo '<form method="post" action="treasure.php">
                                    <button type="submit" name="btn_treasure_skiped" class="btn btn-danger" value="'.$value.'">Skip <i class="fa fa-angle-double-right"></i></button>
                                </form>';
                                ?>
                            </div>
                        </div>
