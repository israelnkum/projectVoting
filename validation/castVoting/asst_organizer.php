            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12 offset-md-0 text-center card-title">
                        <h1 class="display-4">Asst. Organizer</h1>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                    if (isset($_POST['btn_Organizer_skiped'])){

                                    $value = $_POST['btn_Organizer_skiped'];
                                    ...
                                    <div class='container'>
                                        <?php
                                        if ($row["postion"] == "Asst. Organizer" AND $row["votingName"] == $value){
                            ...
                            <div class="text-right">
                                ...
                                <?php
                                echo '<form method="post" action="interestInnovation.php">
                                    <button type="submit" name="btn_asstOrganizer_skiped" class="btn btn-danger" value="'.$value.'">Skip <i class="fa fa-angle-double-right"></i></button>
                                </form>';
                                ?>
                            </div>
                        </div>
