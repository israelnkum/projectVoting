            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12 offset-md-0 text-center card-title">
                        <h1 class="display-4">Intrest & Innovation Cordinator</h1>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class='container'>
                                        <?php
                                        if ($row["postion"] == "Interest & Innovations Cordinator" AND $row["votingName"] == $value){
                            ...
                            <div class="text-right">
                                ...
                                echo '<form method="post" action="">
                                    <button type="submit" name="btn_Interest_skiped" class="btn btn-danger" value="'.$value.'">Skip <i class="fa fa-angle-double-right"></i></button>
                                </form>';
                                ?>
                            </div>
                        </div>
